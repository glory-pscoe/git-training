...
* Has fully decentralized repositories
...
* GIT endorses a lifecycle for managing files and their revisions:

.GIT lifecycle diagram footnote:[from git scm basics documentation at http://git-scm.com/book/en/v2/Git-Basics-Recording-Changes-to-the-Repository]

image::images/ref/gitscm-lifecycle.png[]
...
* Use the compare features and regular commits as a basis for developing incrementally. footnote:[when a change has been committed, it is possible to develop bleeding edge code (refactoring, new features) ... and roll back the changes if necessary.]
